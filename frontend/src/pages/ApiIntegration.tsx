        ...
        {showDocs && (
          <div className="space-y-6 p-5">
            <div className="rounded-lg bg-gray-900 p-4 font-mono text-xs text-gray-100">
              <div>curl -X GET {BASE_URL}/api/v1/containers -H "X-API-Key: ankavm_sk_xxxx"</div>
              <div className="mt-2 text-gray-400">curl -X GET {BASE_URL}/api/v1/dashboard -H "Authorization: Bearer ankavm_sk_xxxx"</div>
            </div>
...
const responseSamples: Record<string, unknown> = {
  ...
  'GET /api/v1/api-keys': {
    success: true,
    data: [{ id: 'c271023f', name: 'Test', prefix: 'ankavm_sk_dd9d...', ip_whitelist: '', created_at: '2026-06-08 15:44:40', last_used: '2026-06-08 15:46:10', scopes: ['*'], last_used_ip: '198.51.100.23' }],
  },
  'POST /api/v1/api-keys': {
    success: true,
    message: "API key created. Save this key now - it won't be shown again.",
    data: { id: 'a1b2c3d4', name: 'Automation', key: 'ankavm_sk_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', prefix: 'ankavm_sk_xxxx...', scopes: ['dashboard:read', 'container:read'] },
  },
  'PATCH /api/v1/api-keys/{id}': { success: true, data: { id: 'a1b2c3d4', name: 'Automation', prefix: 'ankavm_sk_xxxx...', scopes: ['dashboard:read', 'container:read'], disabled: false } },
