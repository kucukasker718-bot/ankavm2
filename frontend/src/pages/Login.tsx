      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
            <div className="flex flex-col items-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-gray-950">AnkaVM</h1>
              <p className="text-gray-500 mt-1 text-sm">{isAccessCodeLogin ? 'Konteyner Yönetim Girişi' : 'Konteyner Yöneticisi'}</p>
            </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">AnkaVM v1.1.20</p>
      </div>
    </div>
  )
}
